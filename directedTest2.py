...
def topology():
    ...
    net = Mininet_wifi(controller=ControlPlane, wmediumd_mode=interference,link=wmediumd,accessPoint=UserAP)
    ...
    c0=net.addController('c0', controller=ControlPlane, ip='10.0.0.254',port=6633)
